...
public abstract class BuffDebuff : MonoBehaviour
{
    ...
    IEnumerator CheckCollisionPlayer()
    {
        ...
        while (true)
        {
            ...
            if (hit2D != null)
            {
                hit2D.GetComponent<BuffDebuffControl>().ApplyBuffDebuff(cf,OnEffect, AfterEffect);
                Destroy(gameObject);
                break;
            }
    ...
    public abstract EffectData OnEffect();

    public abstract void AfterEffect(EffectData data);
}
